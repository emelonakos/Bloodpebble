...
internal class BloodpebbleConfig
{
    ...
    private ConfigEntry<string> CreateConfigEntry_LoadingStrategy(ConfigFile configFile)
    {
        ...
        return configFile.Bind(
            section: "Loader",
            key: "LoadingStrategy",
            defaultValue: "SilverBullet",
            configDescription: new ConfigDescription(loaderDescription, new AcceptableValueList<string>("SilverBullet", "Basic_Deprecated", "Islands_Deprecated"))
        );
    }
